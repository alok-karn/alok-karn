...
[![](https://visitcount.itsvg.in/api?id=alok-karn&label=Profile%20Views&color=3&icon=0&pretty=true)](https://visitcount.itsvg.in)


# ꜰᴜʟʟ ꜱᴛᴀᴄᴋ ᴅᴇᴠᴇʟᴏᴘᴇʀ 👨‍🎨, ᴀɴᴅ ᴛᴇᴄʜ ᴇɴᴛʜᴜꜱɪᴀꜱᴛ 🤖.

- 🔭 I’m currently working on `My Designer Portfolio` ...
- 🌱 I’m currently learning `React Native`, `Next JS`, `🦀Rust` ...
